...
def evaluate_model(X_train, y_train, X_test, y_test, models, params):
    try:
        ...
        for i in range(len(list(models))):          #iterating through all the models one by one
            ...
            model.fit(X_train,y_train)              #training the model with best parameters
...
def load_object(file_path):                       #resonsible for loading pkl files
    try:
